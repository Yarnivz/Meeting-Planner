...
public:
    ...
    static void getCodeContracts(const std::string& baseFilename, bool& multicomment, const std::vector<std::string>& codeFileLines, std::string currentFunction, std::vector<std::string>& preContracts, std::vector<std::string>& postContracts);
